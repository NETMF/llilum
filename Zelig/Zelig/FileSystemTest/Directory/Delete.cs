    ...
    public class Delete : IMFTestInterface
    {
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( DelCurrentDir, "DelCurrentDir" ),
                    new MFTestMethod( DelNonExistent, "DelNonExistent" ),
                    new MFTestMethod( DeleteDirNoSub, "DeleteDirNoSub" ),
                    new MFTestMethod( DeleteDirSub, "DeleteDirSub" ),
                    new MFTestMethod( DeleteDirNoSubWithFile, "DeleteDirNoSubWithFile" ),
                    new MFTestMethod( DeleteDirSubWithFiles, "DeleteDirSubWithFiles" ),
                    new MFTestMethod( DeleteFileInUse, "DeleteFileInUse" ),
                    new MFTestMethod( DeleteReadOnlyDir, "DeleteReadOnlyDir" ),
                    new MFTestMethod( DeleteHiddenDir, "DeleteHiddenDir" ),
                };
             }
        }
    }

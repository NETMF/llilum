    ...
    public class DirectoryInfoTests : IMFTestInterface
    {
        ...
        public MFTestResults DirectoryInfoTest_Constructor1()
        {
            ...
            catch (Exception ex)
            {
                ...
                testResult = true; // ZeligBUG - with out this line testResult = false
            }
        ...
        public MFTestResults DirectoryInfoTest_LastAccessTime0()
        {
            ...
            //if (Directory.GetCurrentDirectory().StartsWith("WINFS"))
            //{
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( DirectoryInfoTest_Constructor0, "DirectoryInfoTest_Constructor0" ),
                    new MFTestMethod( DirectoryInfoTest_Constructor1, "DirectoryInfoTest_Constructor1" ),
                    new MFTestMethod( DirectoryInfoTest_Name0, "DirectoryInfoTest_Name0" ),
                    new MFTestMethod( DirectoryInfoTest_Parent0, "DirectoryInfoTest_Parent0" ),
                    new MFTestMethod( DirectoryInfoTest_Parent1, "DirectoryInfoTest_Parent1" ),
                    new MFTestMethod( DirectoryInfoTest_SubDirectory0, "DirectoryInfoTest_SubDirectory0" ),
                    new MFTestMethod( DirectoryInfoTest_Create0, "DirectoryInfoTest_Create0" ),
                    new MFTestMethod( DirectoryInfoTest_Exists0, "DirectoryInfoTest_Exists0" ),
                    new MFTestMethod( DirectoryInfoTest_Exists1, "DirectoryInfoTest_Exists1" ),
                    new MFTestMethod( DirectoryInfoTest_Delete0, "DirectoryInfoTest_Delete0" ),
                    new MFTestMethod( DirectoryInfoTest_Delete1, "DirectoryInfoTest_Delete1" ),
                    new MFTestMethod( DirectoryInfoTest_Attribute0, "DirectoryInfoTest_Attribute0" ),
                    new MFTestMethod( DirectoryInfoTest_CreationTime0, "DirectoryInfoTest_CreationTime0" ),
                    new MFTestMethod( DirectoryInfoTest_LastAccessTime0, "DirectoryInfoTest_LastAccessTime0" ),
                    new MFTestMethod( DirectoryInfoTest_LastWriteTime0, "DirectoryInfoTest_LastWriteTime0" ),
                    new MFTestMethod( DirectoryInfoTest_GetFiles0, "DirectoryInfoTest_GetFiles0" ),
                };
             }
        }
    }

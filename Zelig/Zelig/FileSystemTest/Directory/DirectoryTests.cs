...
namespace FileSystemTest
{
    ...
    public class DirectoryTests : IMFTestInterface
    {
        ...
        public MFTestResults DirectoryTest_DeleteDirectory4()
        {
            ...
            {
                Log.Exception("Got correct exception", ex);
                testResult = true; // ZeligBUG - remove this line and testResult is always false;
            }
        ...
        public MFTestResults DirectoryTest_MoveDirectory4()
        {
            ...
            try
            {
                ...
                { /* pass case */
                    ...
                    testResult = true; // ZeligBUG - remove this line and testResult = false
                }
            }
            catch (Exception ex)
            {
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( DirectoryTest0_CreateDirectory, "DirectoryTest0_CreateDirectory" ),
                    new MFTestMethod( DirectorytTest1_CreateAndDeleteDirectory, "DirectorytTest1_CreateAndDeleteDirectory" ),
                    new MFTestMethod( DirectoryTest2_CreateExistingDirectory, "DirectoryTest2_CreateExistingDirectory" ),
                    new MFTestMethod( DirectoryTest_CreateDirectory1, "DirectoryTest_CreateDirectory1" ),
                    new MFTestMethod( DirectoryTest_DeleteDirectory1, "DirectoryTest_DeleteDirectory1" ),
                    new MFTestMethod( DirectoryTest_DeleteDirectory2, "DirectoryTest_DeleteDirectory2" ),
                    new MFTestMethod( DirectoryTest_DeleteDirectory3, "DirectoryTest_DeleteDirectory3" ),
                    new MFTestMethod( DirectoryTest_DeleteDirectory4, "DirectoryTest_DeleteDirectory4" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory0, "DirectoryTest_MoveDirectory0" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory1, "DirectoryTest_MoveDirectory1" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory2, "DirectoryTest_MoveDirectory2" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory3, "DirectoryTest_MoveDirectory3" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory4, "DirectoryTest_MoveDirectory4" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory5, "DirectoryTest_MoveDirectory5" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory6, "DirectoryTest_MoveDirectory6" ),
                    new MFTestMethod( DirectoryTest_MoveDirectory7, "DirectoryTest_MoveDirectory7" ),
                    new MFTestMethod( DirectoryTest_Exist1, "DirectoryTest_Exist1" ),
                    new MFTestMethod( DirectoryTest_Exist2, "DirectoryTest_Exist2" ),
                    new MFTestMethod( DirectoryTest_Exist3, "DirectoryTest_Exist3" ),
                    new MFTestMethod( DirectoryTest_GetFiles, "DirectoryTest_GetFiles" ),
                    new MFTestMethod( DirectoryTest_GetCurrentDirectory, "DirectoryTest_GetCurrentDirectory" ),
                    new MFTestMethod( DirectoryTest_SetCurrentDirectory0, "DirectoryTest_SetCurrentDirectory0" ),
                    new MFTestMethod( DirectoryTest_SetCurrentDirectory1, "DirectoryTest_SetCurrentDirectory1" ),
                };
             }
        }
    }

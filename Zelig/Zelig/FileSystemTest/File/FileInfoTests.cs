    ...
    public class FileInfoTests : IMFTestInterface
    {
        ...
        public MFTestResults FileInfoTest_Constructor1()
        {
            ...
            catch (Exception ex)
            {
                ...
                testResult = true; // ZeligBUG - testResult = false if this line is moved
            }
        ...
        public MFTestResults FileInfoTest_CreationTime0()
        {
            ...
            try
            {
                ...
                // Creation time is limited to every 2 seconds
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( FileInfoTest_Constructor0, "FileInfoTest_Constructor0" ),
                    new MFTestMethod( FileInfoTest_Constructor1, "FileInfoTest_Constructor1" ),
                    new MFTestMethod( FileInfoTest_Name, "FileInfoTest_Name" ),
                    new MFTestMethod( FileInfoTest_Length0, "FileInfoTest_Length0" ),
                    new MFTestMethod( FileInfoTest_Length1, "FileInfoTest_Length1" ),
                    new MFTestMethod( FileInfoTest_Length2, "FileInfoTest_Length2" ),
                    new MFTestMethod( FileInfoTest_DirectoryName, "FileInfoTest_DirectoryName" ),
                    new MFTestMethod( FileInfoTest_Directory, "FileInfoTest_Directory" ),
                    new MFTestMethod( FileInfoTest_Directory1, "FileInfoTest_Directory1" ),
                    new MFTestMethod( FileInfoTest_Create0, "FileInfoTest_Create0" ),
                    new MFTestMethod( FileInfoTest_Delete0, "FileInfoTest_Delete0" ),
                    new MFTestMethod( FileInfoTest_Exists0, "FileInfoTest_Exists0" ),
                    new MFTestMethod( FileInfoTest_Exists1, "FileInfoTest_Exists1" ),
                    new MFTestMethod( FileInfoTest_Attributes0, "FileInfoTest_Attributes0" ),
                    new MFTestMethod( FileInfoTest_CreationTime0, "FileInfoTest_CreationTime0" ),
                    new MFTestMethod( FileInfoTest_LastAccessTime0, "FileInfoTest_LastAccessTime0" ),
                    new MFTestMethod( FileInfoTest_LastWriteTime0, "FileInfoTest_LastWriteTime0" ),
                };
             }
        }
    }

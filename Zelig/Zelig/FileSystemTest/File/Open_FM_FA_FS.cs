    ...
    public class Open_FM_FA_FS : IMFTestInterface
    {
        ...
        public MFTestResults FilesShare_None()
        {
            ...
            try
            {
                ...
                {
                    /* pass case */
                    result = MFTestResults.Pass; // ZeligBUG - result is corrupted if it is not used here
                }
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( FilesShare_None, "FilesShare_None" ),
                    new MFTestMethod( FilesShare_Read, "FilesShare_Read" ),
                    new MFTestMethod( FilesShare_Write, "FilesShare_Write" ),
                    new MFTestMethod( FilesShare_ReadWrite, "FilesShare_ReadWrite" ),
                };
             }
        }
    }

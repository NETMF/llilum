    ...
    public class FileTests : IMFTestInterface
    {
        ...
        public MFTestMethod[] Tests
        {
            get
            {
                ...
                {
                    new MFTestMethod( FiletTest_CreateFile0, "FiletTest_CreateFile0" ),
                    new MFTestMethod( FiletTest_CreateFile1, "FiletTest_CreateFile1" ),
                    new MFTestMethod( FiletTest_CloseFile0, "FiletTest_CloseFile0" ),
                    new MFTestMethod( FiletTest_CloseFile1, "FiletTest_CloseFile1" ),
                    new MFTestMethod( FiletTest1_CreateAndDeleteFile, "FiletTest1_CreateAndDeleteFile" ),
                    new MFTestMethod( FiletTest2_CreateAndDeleteFileInUse, "FiletTest2_CreateAndDeleteFileInUse" ),
                    new MFTestMethod( FiletTest_DeleteFile1, "FiletTest_DeleteFile1" ),
                    new MFTestMethod( FiletTest_DeleteFile2, "FiletTest_DeleteFile2" ),
                    new MFTestMethod( FiletTest_MoveFile0, "FiletTest_MoveFile0" ),
                    new MFTestMethod( FiletTest_MoveFile1, "FiletTest_MoveFile1" ),
                    new MFTestMethod( FiletTest_MoveFile2, "FiletTest_MoveFile2" ),
                    new MFTestMethod( FiletTes_MoveFile3, "FiletTes_MoveFile3" ),
                    new MFTestMethod( FiletTest_MoveFile4, "FiletTest_MoveFile4" ),
                    new MFTestMethod( FiletTest_MoveFile6, "FiletTest_MoveFile6" ),
                };
             }
        }
    }

...
{
    public class NetTests : TestBase, ITestInterface
    {
        [SetUp]
        ...
        [TestMethod]
        public TestResult NetTest1_DNS()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult NetTest2_IPAddressBasic()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult NetTest3_IPAddressLoopback()
        {
            /// <summary>
            /// 1. Creates an IPHostEntry for localhost
            /// 2. Verifies that it exists and contains the right data
        ...
        [TestMethod]
        public TestResult NetTest4_IPAddressAny()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult NetTest5_IPEndPointBasic()
        {
            /// <summary>
            /// 1. Creates 30 Random IPs between 0.0.0.0 and 255.255.255.127
        ...
        [TestMethod]
        public TestResult NetTest5_IPHostEntryBasic()
        {
            /// <summary>
            /// 1. Creates an IPHostEntry for localhost
            /// 2. Verifies that it exists and contains the right data
        ...
        [TestMethod]
        public TestResult NetTest6_SocketAddressBasic()
        {
            /// <summary>
            /// 1. Creates 30 Random IPs between 0.0.0.0 and 255.255.255.127
            ...
            return (testResult ? TestResult.Pass : TestResult.KnownFailure);
        }
    }
}

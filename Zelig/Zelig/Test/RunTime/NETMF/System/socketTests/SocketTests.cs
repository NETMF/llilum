...
namespace Microsoft.Zelig.Test
{
    ...
    public class SocketTests : TestBase, ITestInterface
    {
        [SetUp]
        ...
        //        try
        //        {
        //            Log.Comment(hostEntry.AddressList[i].ToString());
        ...
        //[TestMethod]
        //public TestResult SocketTest14_DPWSOptions()
        //{
        //    TestResult testResult = TestResult.Pass;
        ...
        //    Log.Comment("Waiting to receive datagrams from client...");
        //    // This call blocks. 
        ...
        [TestMethod]
        public TestResult SocketTest0_MaxSockets()
        {
            ///<summary>
        ...
        [TestMethod]
        public TestResult SocketTest1_BasicTCP()
        {
            ///<summary>
        ...
        [TestMethod]
        public TestResult SocketTest1_TCP_LingerFalse()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest1_TCP_LingerTrue()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest1_TCP_NoDelay()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest1_TCP_ReceiveTimeout()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest1_TCP_SendTimeout()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest2_BasicUDP()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketTest3_SocketOption()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketTest5_BasicRAW()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketTest6_TCPRecieve()
        {
            /// <summary>
            /// 1. Starts a server socket listening for TCP
            /// 2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest7_TCPSend()
        {
            /// <summary>
            /// 1. Starts a server socket listening for TCP
            /// 2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest8_TCPRecieveFrom()
        {
            /// <summary>
            /// 1. Starts a server socket listening for TCP
            /// 2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest9_TCPSendTo()
        {
            /// <summary>
            /// 1. Starts a server socket listening for TCP
            /// 2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest10_TCPPoll()
        {
            /// <summary>
            /// 1. Starts a server socket listening for TCP
            /// 2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult SocketTest11_SetSocketOptionBasic()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketTest13_DPWSOptions()
        {
            /// <summary>
            /// 1. Starts a server socket listening for UDP
            /// 2. Starts a client socket sending UDP packets

...
{
    public class SocketsEnumsTests : TestBase, ITestInterface
    {
        [SetUp]
        ...
        [TestMethod]
        public TestResult SocketsEnums8_SocketFlags_Peek()
        {
            /// <summary>
            ...
            return (isAnyCatch ? TestResult.Fail : TestResult.Pass);
        }

        [TestMethod]
        public TestResult SocketsEnums9_SocketOptionLevel()
        {
            /// <summary>
            ...
            return (!isAnyCatch ? TestResult.Pass : TestResult.Fail);
        }
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AcceptConnection_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
            ...
            testSockets.TearDown();
            return (testResult ? TestResult.Pass : TestResult.Fail);
        }

        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AddMembership_TCP()
        {
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AddSourceMembership_TCP()
        {
            NetworkInterface[] inter = NetworkInterface.GetAllNetworkInterfaces();
            IPAddress localAddress = SocketTools.ParseAddress(inter[0].IPAddress);
            byte[] local = localAddress.GetAddressBytes();
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_BlockSource_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Broadcast_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_BsdUrgent_TCP()
        {
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Debug_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DontFragment_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DontRoute_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DropMembership_TCP()
        {
            NetworkInterface[] inter = NetworkInterface.GetAllNetworkInterfaces();
            IPAddress localAddress = SocketTools.ParseAddress(inter[0].IPAddress);
            byte[] local = localAddress.GetAddressBytes();
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DropSourceMembership_TCP()
        {
            NetworkInterface[] inter = NetworkInterface.GetAllNetworkInterfaces();
            IPAddress localAddress = SocketTools.ParseAddress(inter[0].IPAddress);
            byte[] local = localAddress.GetAddressBytes();
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Error_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ExclusiveAddressUse_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Expedited_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_HeaderIncluded_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_IPOptions_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_IpTimeToLive_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_KeepAlive_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Linger_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MaxConnections_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MulticastInterface_TCP()
        {
            NetworkInterface[] inter = NetworkInterface.GetAllNetworkInterfaces();
            IPAddress localAddress = SocketTools.ParseAddress(inter[0].IPAddress);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MulticastLoopback_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MulticastTimeToLive_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_NoDelay_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_OutOfBandInline_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_PacketInformation_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveBuffer_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveLowWater_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveTimeout_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReuseAddress_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendBuffer_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendLowWater_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendTimeout_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Type_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_TypeOfService_TCP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_UnblockSource_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_UseLoopback_TCP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Tcp, SocketType.Stream);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AcceptConnection_UDP()
        {
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AddMembership_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_AddSourceMembership_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_BlockSource_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Broadcast_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ChecksumCoverage_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Debug_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DontFragment_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DontRoute_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DropMembership_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_DropSourceMembership_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Error_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ExclusiveAddressUse_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_HeaderIncluded_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_IPOptions_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_IpTimeToLive_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_KeepAlive_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Linger_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MaxConnections_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        //[TestMethod]
        //public TestResult SocketsEnums11_SocketOptionName_MulticastInterface_UDP()
        //{
        //    NetworkInterface[] inter = NetworkInterface.GetAllNetworkInterfaces();
        //    IPAddress localAddress = SocketTools.ParseAddress(inter[0].IPAddress);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MulticastLoopback_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_MulticastTimeToLive_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_NoChecksum_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_OutOfBandInline_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_PacketInformation_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveBuffer_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveLowWater_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReceiveTimeout_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_ReuseAddress_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendBuffer_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendLowWater_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_SendTimeout_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_Type_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_TypeOfService_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_UnblockSource_UDP()
        {
            ////////don't run this on emulator since its not supported.
            //////if (Microsoft.SPOT.Hardware.SystemInfo.SystemID.SKU == 3)
            //////    return TestResult.Skip;
        ...
        [TestMethod]
        public TestResult SocketsEnums11_SocketOptionName_UseLoopback_UDP()
        {
            SocketPair testSockets = new SocketPair(ProtocolType.Udp, SocketType.Dgram);
        ...
        [TestMethod]
        public TestResult SocketsEnums12_SON_AcceptConnection()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketsEnums13_SON_Broadcast()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketsEnums14_SON_ReceiveBuffer()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketsEnums15_SON_SendBuffer()
        {
            /// <summary>

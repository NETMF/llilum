...
{
    public class SocketExceptionTests : TestBase, ITestInterface
    {
        [SetUp]
        ...
        public TestResult SocketExceptionTest2_AddressAlreadyInUse()
        {
            ...
            return (isCorrectCatch ? TestResult.Pass : TestResult.Fail);
        }

        [TestMethod]
        public TestResult SocketExceptionTest3_Protocol_Address_FamilyNotSupported()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest4_ProtocolNotSupported()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest6_IsConnected()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest11_AccessDenied()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest12_NotConnected()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest13_InvalidArgument()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest14_AddressNotAvailable()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest16_HostNotFound()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest17_SocketError()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest18_Fault()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest19_ProtocolOption()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult SocketExceptionTest20_OperationNotSupported()
        {
            /// <summary>

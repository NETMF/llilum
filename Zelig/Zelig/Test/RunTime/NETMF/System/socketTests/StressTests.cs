...
{
    public class StressTests : TestBase, ITestInterface
    {
        [SetUp]
        ...
        [TestMethod]
        public TestResult StressTest1_LargePacketUDP()
        {
            ///<summary>
            ...
            return (testResult ? TestResult.Pass : TestResult.Pass);
        }

        
        [TestMethod]
        public TestResult StressTest2_LargePacketTCP()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server
        ...
        [TestMethod]
        public TestResult StressTest3_LargePacketUDP()
        {
            /// <summary>
        ...
        [TestMethod]
        public TestResult StressTest4_MarathonSend()
        {
            ///<summary>
            ///1. Starts a server socket listening for TCP
            ///2. Starts a client socket connected to the server

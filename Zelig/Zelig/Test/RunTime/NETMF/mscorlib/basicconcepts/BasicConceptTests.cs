...
namespace Microsoft.Zelig.Test
{
    public class BasicConceptTests : TestBase, ITestInterface
    {
        ...
        public override TestResult Run( string[] args )
        {
            ...
            result |= Assert.CheckFailed(  Basic_scope001_Test() );
            result |= Assert.CheckFailed(  Basic_scope002_Test() );
            result |= Assert.CheckFailed(  Basic_scope003_Test() );
            result |= Assert.CheckFailed(  Basic_scope004_Test() );
            result |= Assert.CheckFailed(  Basic_scope005_Test() );
            result |= Assert.CheckFailed(  Basic_scope006_Test() );
            result |= Assert.CheckFailed(  Basic_scope012_Test() );
            result |= Assert.CheckFailed(  Basic_scope019_Test() );
            result |= Assert.CheckFailed(  Basic_scope022_Test() );
            result |= Assert.CheckFailed(  Basic_scope023_Test() );
            result |= Assert.CheckFailed(  Basic_scope024_Test() );
            result |= Assert.CheckFailed(  Basic_scope025_Test() );
            result |= Assert.CheckFailed(  Basic_scope027_Test() );
            result |= Assert.CheckFailed(  Basic_scope029_Test() );
            result |= Assert.CheckFailed(  Basic_scope033_Test() );
            result |= Assert.CheckFailed(  Basic_scope037_Test() );
            result |= Assert.CheckFailed(  Basic_scope041_Test() );
            result |= Assert.CheckFailed(  Basic_scope044_Test() );
            result |= Assert.CheckFailed(  Basic_scope051_Test() );
            result |= Assert.CheckFailed(  Basic_scope053_Test() );
            result |= Assert.CheckFailed(  Basic_scope055_Test() );
            result |= Assert.CheckFailed(  Basic_scope056_Test() );
            result |= Assert.CheckFailed(  Basic_scope057_Test() );
            result |= Assert.CheckFailed(  Basic_scope058_Test() );
            result |= Assert.CheckFailed(  Basic_scope059_Test() );
            result |= Assert.CheckFailed(  Basic_scope061_Test() );
            result |= Assert.CheckFailed(  Basic_scope062_Test() );
            result |= Assert.CheckFailed(  Basic_scope063_Test() );
            result |= Assert.CheckFailed(  Basic_scope064_Test() );
            result |= Assert.CheckFailed(  Basic_scope067_Test() );
            result |= Assert.CheckFailed(  Basic_scope068_Test() );
            result |= Assert.CheckFailed(  Basic_scope069_Test() );
            result |= Assert.CheckFailed(  Basic_scope070_Test() );
            result |= Assert.CheckFailed(  Basic_scope071_Test() );
            result |= Assert.CheckFailed(  Basic_scope074_Test() );
            result |= Assert.CheckFailed(  Basic_nhide001_Test() );
            result |= Assert.CheckFailed(  Basic_nhide002_Test() );
            result |= Assert.CheckFailed(  Basic_nhide003_Test() );
            result |= Assert.CheckFailed(  Basic_nhide004_Test() );
            result |= Assert.CheckFailed(  Basic_nhide005_Test() );
            result |= Assert.CheckFailed(  Basic_nhide006_Test() );
            result |= Assert.CheckFailed(  Basic_nhide007_Test() );
            result |= Assert.CheckFailed(  Basic_nhide008_Test() );
            result |= Assert.CheckFailed(  Basic_nhide009_Test() );
            result |= Assert.CheckFailed(  Basic_nhide010_Test() );
            result |= Assert.CheckFailed(  Basic_nhide011_Test() );
            result |= Assert.CheckFailed(  Basic_nhide012_Test() );
            result |= Assert.CheckFailed(  Basic_nhide013_Test() );
            result |= Assert.CheckFailed(  Basic_nhide014_Test() );
            result |= Assert.CheckFailed(  Basic_nhide015_Test() );
            result |= Assert.CheckFailed(  Basic_nhide016_Test() );
            result |= Assert.CheckFailed(  Basic_nhide017_Test() );
            result |= Assert.CheckFailed(  Basic_nhide018_Test() );
            result |= Assert.CheckFailed(  Basic_nhide019_Test() );
            result |= Assert.CheckFailed(  Basic_nhide020_Test() );
            result |= Assert.CheckFailed(  Basic_nhide021_Test() );
            result |= Assert.CheckFailed(  Basic_nhide022_Test() );
            result |= Assert.CheckFailed(  Basic_nhide023_Test() );
            result |= Assert.CheckFailed(  Basic_nhide024_Test() );
            result |= Assert.CheckFailed(  Basic_nhide025_Test() );
            result |= Assert.CheckFailed(  Basic_nhide026_Test() );
            result |= Assert.CheckFailed(  Basic_nhide027_Test() );
            result |= Assert.CheckFailed(  Basic_nhide028_Test() );
            result |= Assert.CheckFailed(  Basic_nhide029_Test() );
            result |= Assert.CheckFailed(  Basic_nhide030_Test() );
            result |= Assert.CheckFailed(  Basic_nhide031_Test() );
            result |= Assert.CheckFailed(  Basic_nhide032_Test() );
            result |= Assert.CheckFailed(  Basic_nhide033_Test() );
            result |= Assert.CheckFailed(  Basic_nhide034_Test() );
            result |= Assert.CheckFailed(  Basic_nhide035_Test() );
            result |= Assert.CheckFailed(  Basic_nhide036_Test() );
            result |= Assert.CheckFailed(  Basic_nhide037_Test() );
            result |= Assert.CheckFailed(  Basic_nhide038_Test() );
            result |= Assert.CheckFailed(  Basic_nhide039_Test() );
            result |= Assert.CheckFailed(  Basic_nhide040_Test() );
            result |= Assert.CheckFailed(  Basic_nhide041_Test() );
            result |= Assert.CheckFailed(  Basic_nhide042_Test() );
            result |= Assert.CheckFailed(  Basic_nhide043_Test() );
            result |= Assert.CheckFailed(  Basic_nhide044_Test() );
            result |= Assert.CheckFailed(  Basic_nhide045_Test() );
            result |= Assert.CheckFailed(  Basic_nhide047_Test() );
            result |= Assert.CheckFailed(  Basic_nhide049_Test() );
            result |= Assert.CheckFailed(  Basic_nhide050_Test() );
            result |= Assert.CheckFailed(  Basic_nhide051_Test() );
            result |= Assert.CheckFailed(  Basic_nhide053_Test() );
            result |= Assert.CheckFailed(  Basic_nhide055_Test() );
            result |= Assert.CheckFailed(  Basic_nhide056_Test() );
            result |= Assert.CheckFailed(  Basic_nhide057_Test() );
            result |= Assert.CheckFailed(  Basic_nhide059_Test() );
            result |= Assert.CheckFailed(  Basic_nhide061_Test() );
            result |= Assert.CheckFailed(  Basic_nhide062_Test() );
            result |= Assert.CheckFailed(  Basic_nhide063_Test() );
            result |= Assert.CheckFailed(  Basic_nhide064_Test() );
            result |= Assert.CheckFailed(  Basic_nhide067_Test() );
            result |= Assert.CheckFailed(  Basic_nhide068_Test() );
            result |= Assert.CheckFailed(  Basic_nhide071_Test() );
            result |= Assert.CheckFailed(  Basic_nhide072_Test() );
            result |= Assert.CheckFailed(  Basic_nhide075_Test() );
            result |= Assert.CheckFailed(  Basic_nhide076_Test() );
            result |= Assert.CheckFailed(  Basic_nhide077_Test() );
            result |= Assert.CheckFailed(  Basic_nhide079_Test() );
            result |= Assert.CheckFailed(  Basic_nhide081_Test() );
            result |= Assert.CheckFailed(  Basic_nhide082_Test() );
            result |= Assert.CheckFailed(  Basic_nhide085_Test() );
            result |= Assert.CheckFailed(  Basic_nhide086_Test() );
            result |= Assert.CheckFailed(  Basic_nhide087_Test() );
            result |= Assert.CheckFailed(  Basic_nhide088_Test() );
            result |= Assert.CheckFailed(  Basic_nhide089_Test() );
            result |= Assert.CheckFailed(  Basic_nhide090_Test() );
            result |= Assert.CheckFailed(  Basic_nhide091_Test() );
            result |= Assert.CheckFailed(  Basic_nhide092_Test() );
            result |= Assert.CheckFailed(  Basic_memac009_Test() );
            result |= Assert.CheckFailed(  Basic_memac010_Test() );
            result |= Assert.CheckFailed(  Basic_memac011_Test() );
            result |= Assert.CheckFailed(  Basic_memac012_Test() );
            //////result |= Assert.CheckFailed(  Basic_memac013_Test() );
            //////result |= Assert.CheckFailed(  Basic_memac014_Test() );
            result |= Assert.CheckFailed(  Basic_memac019_Test() );
            result |= Assert.CheckFailed(  Basic_memac020_Test() );
            result |= Assert.CheckFailed(  Basic_memac021_Test() );
            result |= Assert.CheckFailed(  Basic_memac022_Test() );
            result |= Assert.CheckFailed(  Basic_memac025_Test() );
            result |= Assert.CheckFailed(  Basic_memac027_Test() );
            result |= Assert.CheckFailed(  Basic_memac029_Test() );
            result |= Assert.CheckFailed(  Basic_memac030_Test() );
            result |= Assert.CheckFailed(  Basic_memac033_Test() );
            result |= Assert.CheckFailed(  Basic_memac034_Test() );
            //////result |= Assert.CheckFailed(  Basic_memac039_Test() );
            //////result |= Assert.CheckFailed(  Basic_memac041_Test() );
            result |= Assert.CheckFailed(  Basic_memac042_Test() );
            result |= Assert.CheckFailed(  Basic_memac043_Test() );
            result |= Assert.CheckFailed(  Basic_memac044_Test() );
            result |= Assert.CheckFailed(  Basic_memac045_Test() );
            result |= Assert.CheckFailed(  Basic_memac046_Test() );
            result |= Assert.CheckFailed(  Basic_memac047_Test() );
            result |= Assert.CheckFailed(  Basic_accon001_Test() );
            result |= Assert.CheckFailed(  Basic_accon003_Test() );
            result |= Assert.CheckFailed(  Basic_accon005_Test() );
            result |= Assert.CheckFailed(  Basic_accon007_Test() );
            result |= Assert.CheckFailed(  Basic_accon009_Test() );
            result |= Assert.CheckFailed(  Basic_accon011_Test() );
            result |= Assert.CheckFailed(  Basic_accon013_Test() );
            result |= Assert.CheckFailed(  Basic_accon015_Test() );
            result |= Assert.CheckFailed(  Basic_accon019_Test() );
            result |= Assert.CheckFailed(  Basic_accon021_Test() );
            result |= Assert.CheckFailed(  Basic_accon023_Test() );
            result |= Assert.CheckFailed(  Basic_accon025_Test() );
            result |= Assert.CheckFailed(  Basic_accon027_Test() );
            result |= Assert.CheckFailed(  Basic_accon029_Test() );
            result |= Assert.CheckFailed(  Basic_accon031_Test() );
            result |= Assert.CheckFailed(  Basic_accon033_Test() );
            result |= Assert.CheckFailed(  Basic_accon035_Test() );
            result |= Assert.CheckFailed(  Basic_accon037_Test() );
            result |= Assert.CheckFailed(  Basic_accon039_Test() );
            result |= Assert.CheckFailed(  Basic_accon041_Test() );
            result |= Assert.CheckFailed(  Basic_accon043_Test() );
            result |= Assert.CheckFailed(  Basic_accon045_Test() );
            result |= Assert.CheckFailed(  Basic_accon047_Test() );
            result |= Assert.CheckFailed(  Basic_accon049_Test() );
            result |= Assert.CheckFailed(  Basic_accon051_Test() );
            result |= Assert.CheckFailed(  Basic_accon053_Test() );
            result |= Assert.CheckFailed(  Basic_accon055_Test() );

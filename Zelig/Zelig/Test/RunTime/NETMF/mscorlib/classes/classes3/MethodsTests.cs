...
namespace Microsoft.Zelig.Test
{
    public class MethodsTests : TestBase, ITestInterface
    {
        ...
        public override TestResult Run( string[] args )
        {
            ...
            string testName = "Methods";
            result |= Assert.CheckFailed(Methods1_Test(), testName, 1);
            result |= Assert.CheckFailed(Methods2_Test(), testName, 2);
            result |= Assert.CheckFailed(Methods3_Test(), testName, 3);
            result |= Assert.CheckFailed(Methods4_Test(), testName, 4);
            result |= Assert.CheckFailed(Methods6_Test(), testName, 6);
            result |= Assert.CheckFailed(Methods7_Test(), testName, 7);
            result |= Assert.CheckFailed(Methods9_Test(), testName, 9);
            result |= Assert.CheckFailed(Methods10_Test(), testName, 10);
            result |= Assert.CheckFailed(Methods11_Test(), testName, 11);
            result |= Assert.CheckFailed(Methods13_Test(), testName, 13);
            result |= Assert.CheckFailed(Methods17_Test(), testName, 17);
            result |= Assert.CheckFailed(Methods19_Test(), testName, 19);
            result |= Assert.CheckFailed(Methods20_Test(), testName, 20);
            result |= Assert.CheckFailed(Methods22_Test(), testName, 22);
            result |= Assert.CheckFailed(Methods23_Test(), testName, 23);
            result |= Assert.CheckFailed(Methods24_Test(), testName, 24);
            result |= Assert.CheckFailed(Methods25_Test(), testName, 25);
            result |= Assert.CheckFailed(Methods26_Test(), testName, 26);
            result |= Assert.CheckFailed(Methods29_Test(), testName, 29);
            result |= Assert.CheckFailed(Methods30_Test(), testName, 30);
            result |= Assert.CheckFailed(Methods33_Test(), testName, 33);
            result |= Assert.CheckFailed(Methods34_Test(), testName, 34);
            result |= Assert.CheckFailed(Methods35_Test(), testName, 35);
            result |= Assert.CheckFailed(Methods56_Test(), testName, 56);
            result |= Assert.CheckFailed(Methods57_Test(), testName, 57);
            result |= Assert.CheckFailed(Methods58_Test(), testName, 58);
            result |= Assert.CheckFailed(Methods59_Test(), testName, 59);
            result |= Assert.CheckFailed(Methods60_Test(), testName, 60);
            result |= Assert.CheckFailed(Methods61_Test(), testName, 61);
            result |= Assert.CheckFailed(Methods66_Test(), testName, 66);
            result |= Assert.CheckFailed(Methods67_Test(), testName, 67);
            result |= Assert.CheckFailed(Methods68_Test(), testName, 68);
            result |= Assert.CheckFailed(Methods69_Test(), testName, 69);
            result |= Assert.CheckFailed(Methods70_Test(), testName, 70);
            result |= Assert.CheckFailed(Methods71_Test(), testName, 71);
            result |= Assert.CheckFailed(Methods75_Test(), testName, 75);
            result |= Assert.CheckFailed(Methods78_Test(), testName, 78);
            result |= Assert.CheckFailed(Methods79_Test(), testName, 79);
            result |= Assert.CheckFailed(Methods80_Test(), testName, 80);
            result |= Assert.CheckFailed(Methods84_Test(), testName, 84);
            result |= Assert.CheckFailed(Methods85_Test(), testName, 85);
            result |= Assert.CheckFailed(Methods92_Test(), testName, 92);
            result |= Assert.CheckFailed(Methods93_Test(), testName, 93);
            result |= Assert.CheckFailed(Methods94_Test(), testName, 94);
            result |= Assert.CheckFailed(Methods95_Test(), testName, 95);
            result |= Assert.CheckFailed(Methods103_Test(), testName, 103);
            result |= Assert.CheckFailed(Methods104_Test(), testName, 104);
            result |= Assert.CheckFailed(Methods105_Test(), testName, 105);
            result |= Assert.CheckFailed(Methods106_Test(), testName, 106);
            result |= Assert.CheckFailed(Methods107_Test(), testName, 107);
            result |= Assert.CheckFailed(Methods108_Test(), testName, 108);
            result |= Assert.CheckFailed(Methods109_Test(), testName, 109);
            result |= Assert.CheckFailed(Methods110_Test(), testName, 110);
            result |= Assert.CheckFailed(Methods111_Test(), testName, 111);
            result |= Assert.CheckFailed(Methods112_Test(), testName, 112);
            result |= Assert.CheckFailed(Methods116_Test(), testName, 116);
            result |= Assert.CheckFailed(Methods117_Test(), testName, 117);
            result |= Assert.CheckFailed(Methods119_Test(), testName, 119);
            result |= Assert.CheckFailed(Methods120_Test(), testName, 120);
            result |= Assert.CheckFailed(Methods121_Test(), testName, 121);
            result |= Assert.CheckFailed(Methods124_Test(), testName, 124);
            result |= Assert.CheckFailed(Methods125_Test(), testName, 125);
            result |= Assert.CheckFailed(Methods132_Test(), testName, 132);
            result |= Assert.CheckFailed(Methods133_Test(), testName, 133);
            result |= Assert.CheckFailed(Methods134_Test(), testName, 134);
            result |= Assert.CheckFailed(Methods142_Test(), testName, 142);
            result |= Assert.CheckFailed(Methods148_Test(), testName, 148);
            ...
            result |= Assert.CheckFailed(Methods172_Test(), testName, 172);
            result |= Assert.CheckFailed(Methods173_Test(), testName, 173);
            result |= Assert.CheckFailed(Methods174_Test(), testName, 174);
            result |= Assert.CheckFailed(Methods175_Test(), testName, 175);
            result |= Assert.CheckFailed(Methods179_Test(), testName, 179);
            result |= Assert.CheckFailed(Methods180_Test(), testName, 180);
            result |= Assert.CheckFailed(Methods181_Test(), testName, 181);
            result |= Assert.CheckFailed(Methods182_Test(), testName, 182);
            result |= Assert.CheckFailed(Methods183_Test(), testName, 183);
            result |= Assert.CheckFailed(Methods184_Test(), testName, 184);
            result |= Assert.CheckFailed(Methods185_Test(), testName, 185);
            result |= Assert.CheckFailed(Methods186_Test(), testName, 186);
            result |= Assert.CheckFailed(Methods187_Test(), testName, 187);
            result |= Assert.CheckFailed(Methods188_Test(), testName, 188);
            result |= Assert.CheckFailed(Methods190_Test(), testName, 190);
            result |= Assert.CheckFailed(Methods191_Test(), testName, 191);
            result |= Assert.CheckFailed(Methods192_Test(), testName, 192);
            result |= Assert.CheckFailed(Methods193_Test(), testName, 193);
            result |= Assert.CheckFailed(Methods194_Test(), testName, 194);
            result |= Assert.CheckFailed(Methods195_Test(), testName, 195);
            result |= Assert.CheckFailed(Methods196_Test(), testName, 196);
            result |= Assert.CheckFailed(Methods197_Test(), testName, 197);
            result |= Assert.CheckFailed(Methods199_Test(), testName, 199);
            result |= Assert.CheckFailed(Methods200_Test(), testName, 200);
            result |= Assert.CheckFailed(Methods201_Test(), testName, 201);
            result |= Assert.CheckFailed(Methods204_Test(), testName, 204);
            result |= Assert.CheckFailed(Methods205_Test(), testName, 205);
            result |= Assert.CheckFailed(Methods206_Test(), testName, 206);
            result |= Assert.CheckFailed(Methods207_Test(), testName, 207);
            result |= Assert.CheckFailed(Methods210_Test(), testName, 210);
            result |= Assert.CheckFailed(Methods223_Test(), testName, 223);
            result |= Assert.CheckFailed(Methods224_Test(), testName, 224);
            result |= Assert.CheckFailed(Methods229_Test(), testName, 229);
            result |= Assert.CheckFailed(Methods230_Test(), testName, 230);
            result |= Assert.CheckFailed(Methods231_Test(), testName, 231);
            result |= Assert.CheckFailed(Methods232_Test(), testName, 232);
            result |= Assert.CheckFailed(Methods233_Test(), testName, 233);

...
namespace Microsoft.Zelig.Configuration.Environment.Abstractions.ARM
{
    ...
    public class MoveFromCoprocessor : Operator
    {
        ...
        private MoveFromCoprocessor( Debugging.DebugInfo debugInfo ,
                                     uint                CpNum     ,
                                     uint                Op1       ,
                                     uint                CRn       ,
                                     uint                CRm       ,
        ...
        public static MoveFromCoprocessor New( Debugging.DebugInfo debugInfo ,
                                               uint                CpNum     ,
                                               uint                Op1       ,
                                               uint                CRn       ,
                                               uint                CRm       ,
        ...
        {
            MoveFromCoprocessor res = new MoveFromCoprocessor( debugInfo, CpNum, Op1, CRn, CRm, Op2 );
        ...
        {
            return RegisterAndCloneState( context, new MoveFromCoprocessor( m_debugInfo, m_CpNum, m_Op1, m_CRn, m_CRm, m_Op2 ) );
        }
        ...
        {
            sb.AppendFormat( "MoveFromCoprocessor(CpNum={0}, Op1={1}, CRn={2}, CRm={3}, Op2={4}", m_CpNum, m_Op1, m_CRn, m_CRm, m_Op2 );
        ...
        {
            return dumper.FormatOutput( "{5} = CoProc(CpNum={0}, Op1={1}, CRn={2}, CRm={3}, Op2={4})", m_CpNum, m_Op1, m_CRn, m_CRm, m_Op2, this.FirstResult );
        }
    }
}
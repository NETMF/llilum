...
namespace Microsoft.Zelig.Configuration.Environment.Abstractions
{
    ...
    public class LLVMCallingConvention : ZeligIR.Abstractions.CallingConvention
    {
        public LLVMCallingConvention( ZeligIR.TypeSystemForCodeTransformation typeSystem )
            : base( typeSystem )
        {
        }

...
namespace Microsoft.Zelig.Runtime
{
    ...
    //
    [TypeSystem.WellKnownType( "Microsoft_Zelig_Runtime_SingletonFactoryPlatformFilterAttributer" )]
    public sealed class SingletonFactoryPlatformFilterAttribute : Attribute
    {
        //
        // State
        //
        ...
        public SingletonFactoryPlatformFilterAttribute( String filter )
        {
            this.Target = filter;
        }
    }

...
////    [MonitoringDescription(SR.DataBits)]
        public int DataBits
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "DataBits", "ArgumentOutOfRange_Bounds_Lower_Upper" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
...
////    [MonitoringDescription(SR.Handshake)]
        public Handshake Handshake
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "Handshake", "ArgumentOutOfRange_Enum" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
////                throw new ArgumentOutOfRangeException( "Handshake", SR.GetString( SR.ArgumentOutOfRange_Enum ) );
        ...
        private void EnsureOpened()
        {
            ...
            {
#if EXCEPTION_STRINGS
               throw new InvalidOperationException( "BaseStream_Invalid_Not_Open" );
#else
        ...
        private void EnsureClosed()
        {
            ...
            {
#if EXCEPTION_STRINGS
                throw new InvalidOperationException( "Cant_be_set_when_open" );
#else
                throw new InvalidOperationException();
#endif
            }
...
////    [MonitoringDescription(SR.Parity)]
        public Parity Parity
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "Parity", "ArgumentOutOfRange_Enum" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
...
////        [ResourceExposure( ResourceScope.Machine )]
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentException( "PortNameEmpty_String" );
#else
                    throw new ArgumentException();
#endif
...
////    [MonitoringDescription( SR.ReadTimeout )]
        public int ReadTimeout
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "ReadTimeout", "ArgumentOutOfRange_Timeout" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
...
////    [MonitoringDescription( SR.ReceivedBytesThreshold )]
        ...
        public int ReceivedBytesThreshold
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "ReceivedBytesThreshold", "ArgumentOutOfRange_NeedPosNum" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
////                throw new ArgumentOutOfRangeException( "ReceivedBytesThreshold", SR.GetString( SR.ArgumentOutOfRange_NeedPosNum ) );
                }
...
////    [MonitoringDescription( SR.StopBits )]
        public StopBits StopBits
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "StopBits", "ArgumentOutOfRange_Enum" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
...
////    [MonitoringDescription( SR.WriteTimeout )]
        public int WriteTimeout
        {
            ...
            set
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new ArgumentOutOfRangeException( "WriteTimeout", "ArgumentOutOfRange_WriteTimeout" );
#else
                    throw new ArgumentOutOfRangeException();
#endif
...
////    [ResourceConsumption( ResourceScope.Machine )]
        public SerialPort( string portName ,
                           int    baudRate ) : this( portName, baudRate, defaultParity, defaultDataBits, defaultStopBits )
        {
        }
...
////    [ResourceConsumption( ResourceScope.Machine )]
        public SerialPort( string portName ,
                           int    baudRate ,
                           Parity parity   ) : this( portName, baudRate, parity, defaultDataBits, defaultStopBits )
        {
        }
...
////    [ResourceConsumption( ResourceScope.Machine )]
        public SerialPort( string portName ,
                           int    baudRate ,
                           Parity parity   ,
                           int    dataBits ) : this( portName, baudRate, parity, dataBits, defaultStopBits )
        {
        }
...
////    [ResourceConsumption( ResourceScope.Machine )]
        ...
        public static extern string[] GetPortNames();
////    {
...
////        new SecurityPermission( SecurityPermissionFlag.UnmanagedCode ).Demand();
            ...
            internalSerialStream = SerialStream.Create( portName, baudRate, parity, dataBits, stopBits, readBufferSize, writeBufferSize, readTimeout, writeTimeout, handshake, dtrEnable, rtsEnable, discardNull, parityReplace );
...
////            throw new ArgumentNullException( "buffer", SR.GetString( SR.ArgumentNull_Buffer ) );
            ...
            {
#if EXCEPTION_STRINGS
                throw new ArgumentOutOfRangeException( "offset", "ArgumentOutOfRange_NeedNonNegNumRequired" );
#else
                throw new ArgumentOutOfRangeException();
#endif
////            throw new ArgumentOutOfRangeException( "offset", SR.GetString( SR.ArgumentOutOfRange_NeedNonNegNumRequired ) );
            ...
            {
#if EXCEPTION_STRINGS
                throw new ArgumentOutOfRangeException( "count", "ArgumentOutOfRange_NeedNonNegNumRequired" );
#else
                throw new ArgumentOutOfRangeException();
#endif
...
////            throw new ArgumentException( SR.GetString( SR.Argument_InvalidOffLen ) );
            ...
            if(CachedBytesToRead >= 1)
            {
                ...
                {
                    if(readPos == readLen)  // just a check to see if we can reset buffer} 
                    {
                        readPos = 0;
                        readLen = 0;
                    }
...
////            throw new ArgumentException( SR.GetString( SR.Argument_InvalidOffLen ) );
        ...
        private int InternalRead( char[] buffer                   ,
                                  int    offset                   ,
                                  int    count                    ,
                                  int    timeout                  ,
        ...
        private int ReadBufferIntoChars( char[] buffer                   ,
                                         int    offset                   ,
                                         int    count                    ,
                                         bool   countMultiByteCharsAsOne )
        {
            ...
            if(encoding.IsSingleByte && encoding.GetMaxCharCount( bytesToRead ) == bytesToRead && fallback != null && fallback.MaxCharCount == 1)
            {
...
////            throw new ArgumentException( SR.GetString( SR.Argument_InvalidOffLen ) );
        ...
        private void CatchPinChangedEvents( object                    src ,
        ...
        private void CatchReceivedEvents( object                      src ,
        ...
        private static int GetElapsedTime( int currentTickCount ,
                                           int startTickCount   )
        {

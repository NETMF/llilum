...
namespace System.Net
{
    ...
    public class WebProxy : IWebProxy
    {
        ...
        private bool m_bypassOnLocal;
        private Uri  m_proxyAddress;  // Uri of proxy itself
        ...
        public bool BypassProxyOnLocal
        {
            get
            {
                return m_bypassOnLocal;
            }

            set
            {
                m_bypassOnLocal = value;
            }
        }

...
namespace Microsoft.SPOT.Messaging
{
    public sealed class EndPoint
    {
        ...
        public EndPoint( Type selector, uint id )
        {
        ...
        public bool Check(Type selector, uint id, int timeout)
        {
            // TODO TODO TODO: Implement
            throw new NotSupportedException( ); 
        }
        ...
        public byte[] SendMessageRaw(Type selector, uint id, int timeout, byte[] payload)
        {
            // TODO TODO TODO: Implement
            throw new NotSupportedException( ); 
        }
        ...
        internal void ReplyRaw(Message msg, byte[] data)
        {
            // TODO TODO TODO: Implement
            throw new NotSupportedException( ); 
        }

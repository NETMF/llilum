...
namespace System.IO
{
    ...
    public sealed class Path
    {
       ...
       */
        ...
        {
            int len = InvalidPathChars.Length;
            char[] retVal = new char[len];

            Array.Copy( InvalidPathChars, retVal, len );
        ...
        */
        ...
        internal static string NormalizePath(string path, bool pattern)
        {
            ...
            if (rootedPath)
            {
                ...
                {
#if EXCEPTION_STRINGS
                    throw new IOException("", (int)IOExceptionErrorCode.VolumeNotFound);
#else
                ...
                {
#if EXCEPTION_STRINGS
                    throw new IOException("", (int)IOExceptionErrorCode.PathTooLong);
#else
                    throw new IOException();
#endif
                }

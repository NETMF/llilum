    ...
    public struct CancellationToken
    {
        ...
        public WaitHandle WaitHandle
        {
            get
            {
                if (m_source == null)
                {
                    m_source = CancellationTokenSource.InternalGetStaticSource(canceled: false);
                }
        ...
        public CancellationTokenRegistration Register(Action callback)
        {
            ...
            return Register(s_ActionToActionObjShunt, callback, useSynchronizationContext: false);
        }
        ...
        public CancellationTokenRegistration Register(Action callback, bool useSynchronizationContext)
        {
            ...
            return Register(s_ActionToActionObjShunt, callback, useSynchronizationContext);
        }
        ...
        public CancellationTokenRegistration Register(Action<object> callback, object state, bool useSynchronizationContext)
        {
            ...
            return m_source.RegisterCallback(callback, state);
        }

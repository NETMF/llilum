...
namespace System
{
    ...
    {
        private static readonly string s_defaultMessage = "One or more errors occurred.";
        private static readonly string s_innerExceptionNull = "An element of innerExceptions was null.";
        ...
        public AggregateException(IEnumerable<Exception> innerExceptions) :
            this(s_defaultMessage, innerExceptions)
        {
        }
            ...
            : base(message, innerExceptions != null && innerExceptions.Count > 0 ? innerExceptions[0] : null)
        {
            ...
            for (int i = 0; i < exceptionsCopy.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(s_innerExceptionNull);
                }
            }

...
////    }
        ...
        private static extern Encoding Latin1
        {
...
////        }
        ...
        public abstract int GetByteCount( char[] chars ,
                                          int    index ,
                                          int    count );
        ...
        [CLSCompliant( false )]
        public virtual unsafe int GetByteCount( char* chars ,
                                                int   count )
        {
        ...
        internal virtual unsafe int GetByteCount( char*      chars   ,
                                                  int        count   ,
                                                  EncoderNLS encoder )
        {
        ...
        public virtual int GetBytes( String s         ,
                                     int    charIndex ,
                                     int    charCount ,
                                     byte[] bytes     ,
                                     int    byteIndex )
        ...
        // Always validate parameters before calling internal version, which will only assert.
        internal virtual unsafe int GetBytes( char*      chars     ,
                                              int        charCount ,
                                              byte*      bytes     ,
                                              int        byteCount ,
                                              EncoderNLS encoder   )
        ...
        [CLSCompliant( false )]
        public virtual unsafe int GetCharCount( byte* bytes ,
                                                int   count )
        {
            // Validate input parameters
            if(bytes == null)
        ...
        // This is our internal workhorse
        // Always validate parameters before calling internal version, which will only assert.
        internal virtual unsafe int GetCharCount( byte*      bytes   ,
                                                  int        count   ,
                                                  DecoderNLS decoder )
        {
        ...
        public abstract int GetChars( byte[] bytes     ,
                                      int    byteIndex ,
                                      int    byteCount ,
                                      char[] chars     ,
                                      int    charIndex );
        ...
        [CLSCompliant( false )]
        public virtual unsafe int GetChars( byte* bytes     ,
                                            int   byteCount ,
                                            char* chars     ,
                                            int   charCount )
        {
        ...
        // This is our internal workhorse
        // Always validate parameters before calling internal version, which will only assert.
        internal virtual unsafe int GetChars( byte*      bytes     ,
                                              int        byteCount ,
                                              char*      chars     ,
                                              int        charCount ,
                                              DecoderNLS decoder   )
...
////    }
        ...
        internal void ThrowBytesOverflow( EncoderNLS encoder        ,
                                          bool       nothingEncoded )
        {
        ...
        internal void ThrowCharsOverflow( DecoderNLS decoder        ,
                                          bool       nothingDecoded )
        {

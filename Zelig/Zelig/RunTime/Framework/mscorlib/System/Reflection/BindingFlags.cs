...
namespace System.Reflection
{
    ...
    public enum BindingFlags
    {
        ...
        IgnoreCase           = 0x00000001, // Ignore the case of Names while searching
        DeclaredOnly         = 0x00000002, // Only look at the members declared on the Type
        Instance             = 0x00000004, // Include Instance members in search
        Static               = 0x00000008, // Include Static members in search
        Public               = 0x00000010, // Include Public members in search
        NonPublic            = 0x00000020, // Include Non-Public members in search
        FlattenHierarchy     = 0x00000040, // Rollup the statics into the class.
        ...
        ExactBinding         = 0x00010000,      // Bind with Exact Type matching, No Change type

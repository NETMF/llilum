...
////    internal static MatchNumberDelegate m_hebrewNumberParser = new MatchNumberDelegate( DateTimeParse.MatchHebrewDigits );
        ...
        internal static extern DateTime ParseExact( String             s      ,
                                                    String             format ,
...
////        if(format.Length == 0)
////        {
////            result.SetFailure( ParseFailureKind.Format, "Argument_BadFormatSpecifier", null );
////            return false;
////        }
////
...
////    }
        ...
        [MethodImplAttribute( MethodImplOptions.InternalCall )]
        internal static extern DateTime ParseExactMultiple( String             s       ,
                                                            String[]           formats ,
                                                            DateTimeFormatInfo dtfi    ,
                                                            DateTimeStyles     style   );
////    {
...
////    {
////        //
////        // <TODO> When we support more timezone, change this to return an instance of TimeZone.</TODO>
////        //
...
////    }
        ...
        [MethodImplAttribute( MethodImplOptions.InternalCall )]
        internal static extern DateTime Parse( String             s      ,
                                               DateTimeFormatInfo dtfi   ,
